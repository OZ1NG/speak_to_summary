...
def summarize_text(text, previous_summary=None, categories_keywords=None):
    if previous_summary:
        prompt = (
            "Refine and extend the following summary with new content added in a detailed and structured markdown format. "
            "Make the summary comprehensive and closer to a detailed content outline rather than just a brief overview. "
            "Include bullet points, headings, key details, and consider the provided categories and keywords to ensure the most essential information is highlighted. "
            "Categories and Keywords: \n" + categories_keywords + "\n"
            "Previous Summary: \n" + previous_summary + "\n" +
